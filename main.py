def f(word_in, cypher, step):
    ...
    параметры step: шаг шифрования или 0 по длине слова
        ...
        if a.isalpha():
            ...
            if tmp:
                for b in tmp:
                    ...
                    if b.isupper():
                        abc_code = 65 if ord(b) < 123 else 1040  # коды буквы в английском и русском алфавите
                        c = (ord(b) - abc_code + x) % abc_count + abc_code  # шифрование и дешифрование букв
                    else:
